...
/***/ (function(module, exports, __webpack_require__) {
	...
	var carousels = __webpack_require__(4);
	var overlays = __webpack_require__(7);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	//SET containers
	$('.box-out, .instagram-feed ul, .instagram-feed-text, ul.document-list.two-col li a, .nav-sublist li, .carousel-item-content ul li, .eq, .feature-text.feature-text-large h3').matchHeight();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (featureCarousel.length) {
		...
		$('.feature-panel .prev-slide').on('click', function () {
			$('.feature-carousel .slick-prev').trigger('click');
			$(this).blur();
		});
		$('.feature-panel .next-slide').on('click', function () {
	...
	if (boxOutCarousel.length) {
		...
		$('.latest-updates .prev-slide').on('click', function () {
			boxOutCarousel.find('.slick-prev').trigger('click');
			$(this).blur();
		});
		$('.latest-updates .next-slide').on('click', function () {
	...
	if (cycleCarousel.length) {
		var setButtonLink = function setButtonLink() {
			var buttonLink = cycleCarousel.find('.slick-slide.slick-active .feature-text a.button').attr('href');
...
/***/ (function(module, exports) {
	...
	var mediaOverlayTrigger = $('a.trigger__image__overlay, a.trigger__image__overlay + a.media-fullscreen, .trigger__video a');
	if (mediaOverlayTrigger.length) {
		$('body').prepend('<div class="overlay-fade overlay-media"><div class="media-container"><a href class="media-close" style="display:none;">Close overlay</a><a download="" href class="media-download" title="Download image" style="display:none;">Download image</a></div></div>');
	}

	function resizeOverlayMediaItem() {
		var overlayMediaItem = $('.overlay-media img, .overlay-media video'),
		...
		if ($('.overlay-media video').length) {
			var mediaButtons = $('.media-container a:not(.media-download)');
		} else {
			var mediaButtons = $('.media-container a');
		}

		setTimeout(function () {
			var rt = $(window).width() - (overlayMediaItem.offset().left + overlayMediaItem.outerWidth());
	...
	mediaOverlayTrigger.on('click', function () {
		var itemLinkURL = $(this).attr('href');

		if (itemLinkURL.indexOf('.mp4') != -1) {
			//videos
			var mediaContainerContent = '<video autoplay controls><source src="' + itemLinkURL + '" type="video/mp4">Your browser does not support the video tag.</video>';
		} else {
			//images
			var mediaContainerContent = '<img src="' + itemLinkURL + '"/>';
		}

		$('.overlay-media').fadeIn().find('.media-container').append(mediaContainerContent).fadeIn();
		$('.overlay-media a.media-download').attr('href', itemLinkURL);
